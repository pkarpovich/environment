...
export const SHORTCUTS_DATA: ShortcutsData = {
    ...
    obsidian: {
        ...
        groups: [
            ...
            {
                name: "Mode",
                shortcuts: [{ keys: ["CMD", "R"], action: "Toggle Read/Edit view", actionKeys: ["R"] }],
            },
            {
                name: "Periods",
                shortcuts: [
        ...
        groups: [
            {
                ...
                shortcuts: [
                    {
                        keys: ["ALT", "SHIFT", "1-9,0"],
                        action: "Switch to tab",
                        actionKeys: ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"],
                    },
            ...
            {
                name: "Copy Mode",
                shortcuts: [{ keys: ["ALT", "SHIFT", "V"], action: "Enter Copy Mode", actionKeys: ["V"] }],
            },
            {
...
export const KEYBOARD_LAYOUT: KeyInput[][] = [
    ...
    [
        { key: "⇧", width: "shift-l", id: "shift-l", modifier: true },
        "Z",
        "X",
        "C",
        "V",
        ...
        ".",
        "/",
        { key: "⇧", width: "shift-r", id: "shift-r", modifier: true },
    ],
    [
