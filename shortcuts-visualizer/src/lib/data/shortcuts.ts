...
export const KEYBOARD_LAYOUT_SHIFT: KeyInput[][] = [
    [
        { key: '"', id: "`" },
        { key: "1", id: "1" },
        { key: "2", id: "2" },
...
export const KEYBOARD_LAYOUT_RU_SHIFT: KeyInput[][] = [
    [
        { key: '"', id: "`" },
        { key: "1", id: "1" },
        { key: "2", id: "2" },
...
export const KEYBOARD_LAYOUT_ALT: KeyInput[][] = [
    [
        { key: "`", id: "`" },
        { key: "¹", id: "1" },
        { key: "²", id: "2" },
...
export function getShiftLayout(lang: KeyboardLang): KeyInput[][] {
    return lang === "ru" ? KEYBOARD_LAYOUT_RU_SHIFT : KEYBOARD_LAYOUT_SHIFT;
}

export function getAltLayout(lang: KeyboardLang): KeyInput[][] {
    return KEYBOARD_LAYOUT_ALT;
}
